...
export function requireAuthentication(Component) {
  return class AuthenticatedComponent extends React.Component {
    ...
    isAuthenticated() {
      ...
      const unPrivate = ['/candidates/[pid]/verify', '/login', '/register', '/verify', '/forgot-password', '/reset-password', '/', '/404', '/superadmin', '/403','/upload-candidate', '/upload-home','/upload-cv-home'];
