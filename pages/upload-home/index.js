    ...
    <div className='home-page'>
      ...
      <div className="container job">
        <div className="row">
          ...
          <div className="col-sm-3"  >
            <div className="row news-right" style={{ padding: 10, background: '#C4C4C4', borderRadius: 8, margin: '30px 0px 0px 20px' }}>
              <div style={{ padding: 10 }}>
                <Title level={3}>TÌM VIỆC KHÓ - CÓ  ROCKSEARCH</Title>
                <div className="content-news" style={{ marginTop: 20, textAlign: 'center', marginBottom: 20 }}><Button onClick={() => changeStatus()} type="danger"  >Upload CV của bạn tại đây</Button></div>
                <Title level={4}>SỞ HỮU NGAY CV XỊN CÙNG VIỆC LÀM MƠ ƯỚC</Title>
                <p>30.000+ cơ hội việc làm được kết nối thành công qua Rocksearch mỗi ngày</p>
              </div>
              {/* <Title level={3} className="title-right">Company Spotlight</Title> */}
